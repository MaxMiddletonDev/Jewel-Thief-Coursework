...
public class SkinRegistry {
    ...
    static {
        ...
        register(new Skin(SkinId.SPEED_GUY, "Speed guy", "/cs230/group29se/jewelthief/Images/Entities/Player/PLAYER_SPEEDSTER.png"));
        register(new Skin(SkinId.CAT_CAT, "Cat Cat", "/cs230/group29se/jewelthief/Images/Entities/Player/PLAYER_TANK.png"));
    }
